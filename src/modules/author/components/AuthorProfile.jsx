...
export default function AuthorProfile() {
  ...
  const fetchProfile = async () => {
    try {
      setLoading(true)
      const response = await axiosClient.get(`/api/profile/author/${userId}`)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (otherLink) formData.append("otherLink", otherLink)
      if (image) formData.append("profileImage", image)

      const response = await axiosClient.put(`/api/profile/author/${userId}`, formData, {
        headers: {
      ...
      const updatedData = response.data.authorProfile
      ...
      setOtherLink(updatedData.otherLink || "")
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold">Author Profile</h1>
          <p className="text-muted-foreground mt-2">Manage your author profile information</p>
        </div>
          ...
          <div className="md:col-span-3 lg:col-span-1">
            <div className="bg-card border border-border rounded-lg p-6 text-center sticky top-20">
              {imagePreview ? (
                ...
                <div className="w-32 h-32 mx-auto bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg mb-4 flex items-center justify-center">
            ...
            <div className="bg-card border border-border rounded-lg p-6 space-y-6">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  {otherLink && (
                    <div className="p-3 bg-background rounded-lg border border-border/50">
                      <p className="text-xs text-muted-foreground mb-1">Website/Link</p>
                      <a
                        href={otherLink}
                        target="_blank"
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., Software Engineer, Writer, Designer"
                className="w-full px-4 py-2 bg-card border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              />
            </div>
            ...
            <div>
              <label className="block text-sm font-medium mb-2">Other Links</label>
              <input
                type="url"
                value={otherLink}
